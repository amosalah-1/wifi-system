interface PricingCardProps {
  ...
  description: string;
  highlighted?: boolean;
  onConnect: (planName: string, price: number) => void;
}
  ...
  return (
    <div className="flex flex-col h-full rounded-2xl overflow-hidden">
      ...
      <div className="bg-secondary p-6 flex items-center justify-center">
        <button
          onClick={() => onConnect(planName, price)}
          className="bg-white text-secondary font-semibold px-8 py-3 rounded-full hover:bg-gray-100 transition-colors"
        >
